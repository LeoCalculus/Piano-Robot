...
/* File entry structure for text file listing */
typedef struct {
...
// Detect SD card presence (assuming GPIO pin connected to SD card detect switch)
// function parameter is CS PIN for SD card
...
/* Text file listing (backward compatible) */
