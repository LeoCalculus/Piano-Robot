...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LCD_RS_Pin|GPIO_PIN_10|GPIO_PIN_12|GPIO_PIN_13
                          ...
                          |Solenoid_1_Pin|Solenoid_2_Pin|Solenoid_3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_RS_Pin PB10 PB12 PB13
                           PB14 PB15 PB3 PB4
                           Solenoid_1_Pin Solenoid_2_Pin Solenoid_3_Pin */
  ...
  /*Configure GPIO pins : GPIO_EXTI5_LEFT_Pin GPIO_EXTI6_RIGHT_Pin */
  GPIO_InitStruct.Pin = GPIO_EXTI5_LEFT_Pin|GPIO_EXTI6_RIGHT_Pin;
