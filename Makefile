##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.6.0.1-B1] date: [Thu Jan 22 23:31:45 PST 2026] 
##########################################################################################################################
...
# source
######################################
# Recursive wildcard function for LVGL
rwildcard=$(foreach d,$(wildcard $(1:=/*)),$(call rwildcard,$d,$2) $(filter $(subst *,%,$2),$d))

# LVGL sources (all .c files under lvgl/src)
LVGL_SOURCES = $(call rwildcard,lvgl/src,*.c)
...
-Ilvgl/src/display \
-Ilvgl/src/font \
-Ilvgl/src/font/binfont_loader \
-Ilvgl/src/font/fmt_txt \
-Ilvgl/src/font/imgfont \
-Ilvgl/src/font/font_manager \
-Ilvgl/src/widgets \
-Ilvgl/src/xml \
-Ilvgl/src/debugging \
-Ilvgl/src/debugging/sysmon \
-Ilvgl/src/debugging/monkey \
-Ilvgl/src/debugging/test \
-Ilvgl/src/others \
-Ilvgl/src/others/fragment \
-Ilvgl/src/others/file_explorer \
-Ilvgl/src/others/translation \
-Ilvgl/src/libs \
-Ilvgl/src/layouts \
-Ilvgl/src/draw \
-Ilvgl/src/draw/sw \
-Ilvgl/src/draw/eve \
-Ilvgl/src/draw/snapshot \
-Ilvgl/src/themes \
-Ilvgl/src/drivers \
